...
ладонью по твоему лбу. Её ладонь была прохладной. -- Я никогда не думала, что... -- она не окончила фразу.]];
			next = '#земля';
		};
		{
			'Нет',
			[[-- Не беспокойся, всё будет хорошо! -- с этими словами девушка подошла и провела
ладонью по твоему лбу. Её ладонь была прохладной. -- Бедный, тебя никто не ждёт...^Её глаза наполнились грустью.]];
			next = '#земля';
		}
	};
	{
		...
		{
			'Что это за место?';
			[[-- Это Марс. Разве ты не знаешь? -- Её лицо тронула улыбка.]]
		};
		{
