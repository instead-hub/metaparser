...
obj {
	...
	description = function(s)
		p [[Маяк достигает в высоту 60 метров. Его белая башня установлена на небольшом утёсе, омываемым морем с
севера, запада и юга.]];
		if visited 'закат' then
...
obj {
	...
	description = function()
		p [[Высота маяка достигает 60 метров. Белый цвет башни сильно контрастирует с марсианским пейзажем.
