...
room {
	...
	dsc = function(s)
		if s:once() then
			p [[Дверь оказалась незапертой, и ты вошёл внутрь маяка. Неожиданно, Дея схватила тебя за руку и прошептала:^^
...
себя и не могли этому помешать.]];
		...
		[[-- Мы обнаружили, что находясь в экстремальных ситуациях, а также на едине со своими мыслями -- вы часто преодолеваете свою тёмную сторону. Но не тогда, когда объединяетесь вместе. Не тогда, когда чувство власти и силы опьяняет вас. Тогда очень немногие способны противостоять хаосу внутри себя.]];
		[[-- И тогда мы попробовали помочь. Марс стал для вас новым домом, вашей лечебницей.]];
	};
...
cutscene {
	...
	text = {
		...
		[[-- Может быть, когда-нибудь вы будете готовы жить вместе с нами и вы станете новыми хозяевами Марса. Но не сейчас.]];
