...
room {
	...
	title = "В арке";
	dsc = function(s)
		p [[Яркий свет фонаря отражается от клубов синего пара, сквозь которые просвечиваются
чёрные стены.]]
	end;
	dark_dsc = function(s)
		if s:once() then
...
obj {
	-"пар,дым,клубы*";
	description = "Синие клубы пара обволакивают твой скафандр и это пугает. Ты не ожидал увидеть здесь ничего подобного! Надо будет обязательно придти сюда еще раз и взять пробы.";
	found_in = 'арка2';
}:attr 'scenery';
