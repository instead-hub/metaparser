...
obj {
	-"девушка,женщ*|марсианин|марисанка";
	nam = 'девушка';
	step = 0;
	listen = false;
	dsc = [[Рядом с тобой стоит девушка.]];
	description = [[Ты видишь длинные волосы, юное лицо... Скафандр. На ней нет скафандра. Ты мельком смотришь на приборы.
Минусовая температура, ветер. Сердце выпрыгивает из груди. Что за... Наваждение...]];
	before_Listen = function(s)
		p [[Ты видишь, что девушка что-то говорит тебе. Но ты слышишь только пульсацию крови в висках.
...
{$fmt em|Она хочет, чтобы я снял шлем!}]]
		s.listen = true
	end;
	each_turn = function(s)
		s.step = s.step + 1
