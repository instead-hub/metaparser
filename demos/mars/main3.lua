...
к ним нужно идти на север.]];
	found_in = 'марс1';
	description = [[Марсианский пейзаж ты видел тысячи раз на снимках и записях. Он именно такой, каким и должен быть: широкие горы, причудливые изгибы каньонов и
