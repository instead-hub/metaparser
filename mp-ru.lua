...
Verb {
	"#Cut",
	"[ |раз|на|по|от]рез/ать,[ |раз|на|по|от]реж/ь",
	"{noun}/вн : Cut",
...
Verb {
	"#Attack",
	"атак/овать,бить,бей/,удар/ить,[ |с|раз|по|вы|вз]лома/ть,уби/ть,[ |раз]разруш/ить,поби/ть,побей/,побь/,круш/ить,напасть,напад/ать,пнуть",
	"?на {noun}/вн : Attack"
}
