...
Verb {
	"#Touch",
	"[ |по]трога/ть,трон/уть,дотрон/уться,[ |при]косну/ться,касать/ся,[ |по]щупа/ть,[ |по]глад/ить",
	"{noun}/вн : Touch",
	"~ до {noun}/рд : Touch",
	"~ к {noun}/дт : Touch",
	"~ {noun}/рд : Touch",
...
Verb {
	"#Attack",
	"атак/овать,бить,бей/,удар/ить,[ |с|раз|по]лома/ть,уби/ть,[ |раз]разруш/ить,поби/ть,побей/,побь/,круш/ить,напасть,напад/ать",
	"?на {noun}/вн : Attack"
}
