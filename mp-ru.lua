...
--"надет"
mp.msg.Take.WORN = "{#First} {#word/надет,#first} на {#if_hint/#firstwhere,live,{#firstwhere/пр,2},{#firstwhere/вн}}."
...
Verb {
	"#Turn",
	"враща/ть,поверн/уть,верт/есть,поверт/еть,крути/ть",
	"{noun}/вн : Turn"
}
...
Verb {
	"#Touch",
	"трога/ть,потрог/ать,трон/уть,дотрон/уться,косну/ться,касать/ся,прикосн/уться,щупа/ть,пощупа/ть,глад/ить,поглад/ить",
	"{noun}/вн : Touch",
	"~ до {noun}/рд : Touch",
	"~ к {noun}/дт : Touch",
	"~ {noun}/рд : Touch",
