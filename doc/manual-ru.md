...
включены необходимые для работы МЕТАПАРСЕРА3 модули morph и parser и специальная тема для парсерных игр.
...
Также, в подкаталоге demos находится несколько демонстрационных игр.
Вы можете скопировать необходимые файлы любой из игр (обычно main3.lua и dict.mrd)
в каталог с МП3 и запустить её. Или наоборот, скопировать нужные каталоги и файлы
МП3 (morph, parser, theme, theme.ini) в каталог с демонстрационной игрой.
...
|mp:cls_prompt()                 | Очистить сообщение с последней введённой командой в окне МП
