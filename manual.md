...
свое выполнение. В противном случhttps://www.gazeta.ru/ае она завершается на этом шаге.
...
1) w:before\_Any() -- если не false, продолжать
2) w:before\_Listen() -- только если у объекта определено свойство before\_Listen
3) w:before\_Default() -- если у объекта не определено свойство
before\_Listen
